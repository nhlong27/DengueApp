...
const MainContentCard = (
  ...
  return (
    <div className="shadow-lg z-10 mb-8  grid h-[20rem] min-w-[15rem] w-[25%] grid-cols-2 grid-rows-5 gap-4 divide-y-2 divide-gray-400 rounded-lg bg-auto-white p-4 transition-all duration-300 ease-in-out hover:ring-2 hover:bg-white hover:ring-gray-300">
      <div className="col-span-2 row-span-4 flex flex-col items-center justify-between">
        <div className="bg-gray-400 w-[80%] h-[70%] row-span-3 mt-4 rounded-full">Avatar</div>
