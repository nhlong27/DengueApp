...
const MainContentCard = (
  ...
  return (
    <div className="hover:shadow-xm z-10 mb-8  grid h-[20rem] w-[25%] grid-cols-2 grid-rows-5 gap-4 divide-y-2 divide-gray-400 rounded-3xl bg-cyan-100 p-4 transition-all duration-300 ease-in-out hover:ring-2 hover:ring-gray-300">
