...
const Sidebar = () => {
  return (
    <div className="flex w-[15%] shrink-0 flex-col bg-black">
      <Link
        to="/pages/dashboard/doctor/index.html"
        className="mx-4 mb-8 flex font-bold h-[10%] items-center justify-start p-4 text-large text-auto-white"
      >
        <img className='w-[3rem] h-[3rem]' src="../../../../assets/img/mos_files/mos.png" alt="mos" />
        DengueApp
      </Link>
      ...
      <div className="mr-2 flex flex-col gap-2 pb-8 ">
        <Link
          to="/pages/dashboard/doctor/index.html"
          className="duration-400 flex items-center justify-start p-4  px-8 text-auto-white transition-all hover:border-r-2 hover:border-auto-white hover:bg-gradient-to-r hover:from-blue-600 hover:pl-12 hover:text-[17px] focus:border-r-2 focus:border-auto-white focus:bg-gradient-to-r focus:from-blue-600 focus:pl-12 focus:text-[17px] focus:text-auto-white "
        >
          Dashboard
        </Link>
        <Link
