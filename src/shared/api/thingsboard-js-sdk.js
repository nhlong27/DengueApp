...
class tbClient {
  ...
  async connect(isPublic = false) {
    ...
    if (isPublic === true) {
      result = await this.api
        .post('/api/auth/login/public', { publicId: this.config.publicId })
  ...
  getCustomers(
    { textSearch, sortOrder, sortProperty } = {
      textSearch: '',
      sortOrder: '',
      sortProperty: '',
    },
    ...
    return this.api
      .get(`/api/customers?page=0&pageSize=10${textSearch}`)
      .then((response) => {
  ...
  getCustomerUsers(
    ...
    return this.api
      .get(
        `/api/customer/${customerId}/users?page=0&pageSize=10${textSearch}${sortOrder}${sortProperty}`,
      )
      .then((response) => {
        response && console.log('return:');
        console.log(response.data);
  ...
  getAllUsers(
    ...
    return this.api
      .get(`/api/users?page=0&pageSize=10${textSearch}${sortOrder}${sortProperty}`)
      .then((response) => {
        response && console.log('return:');
        console.log(response.data);
        return response.data;
  ...
  async saveUser(params) {
    ...
    const result = await this.api
      .post(`/api/user?sendActivationMail=true`, params)
      .then((response) => {
        response && console.log('return:');
        console.log(response.data);
        return response.data;
  ...
  getAssetByName(name) {
    ...
    return this.api
      .get(`/api/tenant/assets?assetName=${name}`)
      .then((response) => {
        response && console.log('return:');
        console.log(response.data);
        return response.data;
  ...
  getDevices(
    ...
    return this.api
      .get(
        `/api/tenant/devices?page=0&pageSize=10${textSearch}${sortOrder}${sortProperty}`,
      )
      .then((response) => {
        response && console.log('return:');
        console.log(response.data);
  ...
  getCustomerAssets(
    ...
    return this.api
      .get(
        `/api/customer/${customerId}/assets?page=0&pageSize=10${textSearch}${sortOrder}${sortProperty}`,
      )
      .then((response) => {
        response && console.log('return:');
        console.log(response.data);
